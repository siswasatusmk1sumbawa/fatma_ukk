...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
  ...
  $namaalbum = trim($namaalbum);
  $namaalbum = stripslashes($namaalbum);
  $namaalbum = htmlspecialchars($namaalbum);
        ...
        <div class="col-sm-3">
          ...
          <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>" method="POST">
            ...
            <div class="mb-3">
              ...
              <textarea name="deskripsi" id="deskripsi" class="form-control" rows="7" placeholder="enter deskripsi album"></textarea>
            </div>
